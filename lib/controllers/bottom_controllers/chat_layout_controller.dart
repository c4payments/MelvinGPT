...
import 'package:melvingpt/bot_api/api_services.dart';
import 'package:melvingpt/screens/bottom_screens/chat_layout/layouts/suggestion_list.dart';
import 'package:melvingpt/models/quiestions_suggestion_model.dart';
import '../../config.dart';
...
class ChatLayoutController extends GetxController
  ...
  List<String> shareMessages = ['--THIS IS CONVERSATION with melvingpt--\n\n'];
  ...
  getChatId() {
    ...
    if (Get.arguments != null) {
      ...
      shareMessages
          .add("${appCtrl.selectedCharacter["message"]} - By melvingpt\n");
      selectedMessages
          .add("${appCtrl.selectedCharacter["message"]} - By melvingpt\n");
  ...
  onTapShare() {
    Share.share(selectedData.toString(),
        subject: "I'm sharing Conversation with melvingpt");
    update();
  }
